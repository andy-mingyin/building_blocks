...
I can take the mean of the sample, too! The mean is 0.0291536.

\subsection{learning assessment}\label{learning-assessment}

\subsection{I loaded necessary packages(ex.
tidyverse)}\label{i-loaded-necessary-packagesex.-tidyverse}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{la.df}\OtherTok{=}
  \FunctionTok{tibble}\NormalTok{(}
    \AttributeTok{norm\_samp=}\FunctionTok{rnorm}\NormalTok{(}\AttributeTok{n=}\DecValTok{500}\NormalTok{, }\AttributeTok{mean=}\DecValTok{1}\NormalTok{),}
    \AttributeTok{samp\_geq0=}\NormalTok{norm\_samp}\SpecialCharTok{\textgreater{}}\DecValTok{0}\NormalTok{,}
    \AttributeTok{abs\_v\_samp=}\FunctionTok{abs}\NormalTok{(norm\_samp)}
\NormalTok{  )}
\FunctionTok{ggplot}\NormalTok{(la.df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{abs\_v\_samp)) }\SpecialCharTok{+} 
